...
class One_pence(Coin):
	...
	super().__init__(**data) #super is parant class
...
coins = [One_pence(),Twenty_Pence(),Fifty_Pence(),Ten_Pence(),
		Twenty_Pence(),Fifty_Pence(),Pound(),Two_Pound()]

for coin in coins:
	arguments = [coin,coin.colour,coin.value,coin.diameter,coin.thickness,
				coin.num_edges,coin.mass]
	string = '{}-Colour: {},value: {},diameter(mm): {},thickness: {},number of edges: {},mass: {}'.format(*arguments)
	print(string)